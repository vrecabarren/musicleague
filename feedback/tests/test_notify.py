...
from feedback.notify import HTML_PATH
from feedback.notify import TXT_PATH
from feedback.notify import _html_email
from feedback.notify import _send_email
from feedback.notify import _txt_email
from feedback.tests.utils.decorators import env_deployed
from feedback.tests.utils.decorators import env_local
from feedback.tests.utils.environment import set_environment_state


PATH = 'feedback.notify.%s'
