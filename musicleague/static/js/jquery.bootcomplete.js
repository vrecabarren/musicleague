    ...
    $.fn.bootcomplete = function(options) {
        ...
        function selectResult(){
            ...
            if (settings.idField) {
                ...
                if (inputs.length !== 0) {
                    var addedMember = '<span class="member added-member" data-id="'+$(this).data('id')+'" data-name="'+$(this).data('label') +'">'+$(this).data('label')+'&nbsp;<a class="btn delete-member-btn">Delete</a></span>';
