            ...
            <div className="song">
                ...
                <div className="comment-inp row">
                    <div className="col-xs-12 col-sm-8">
                        <input type="text" className="commentInput" placeholder="Leave a comment on the song above (optional)" uri={this.props.uri} maxLength="255" value={this.props.previousComment} onChange={this.onComment.bind(this)}/>
                    </div>
                </div>
            </div>
         );
